...
function create_fragment(ctx) {
  ...
  var block = {
    c: function create() {
      ...
      h1.textContent = "I m the best";
      (0, _internal.add_location)(p, file, 6, 2, 66);
      (0, _internal.add_location)(h1, file, 7, 2, 91);
    },
...
function instance($$self, $$props, $$invalidate) {
  ...
  var _$$props$name = $$props.name,
      name = _$$props$name === void 0 ? "Anonymous" : _$$props$name;
